# CLAUDE.md — Novel_Assistant

> 이 파일을 `D:\2027_Novel_Assistant\CLAUDE.md`에 복사해서 사용
...
| 프로젝트 노트 | `D:\2027_Git\gabi_plan_control\40_Projects\30_Writing\글쓰기어시스턴트\` |
...
- **GitHub**: kkanbi/Novel_Assistant
- **로컬 경로**: `D:\2027_Novel_Assistant`
- **연결된 vault**: `D:\2027_Git\gabi_plan_control`
- **목표**: 웹소설 챕터 자동생성 어시스턴트
- **마감**: 2026-03-31

...
|---|-------|---------|---------|-------|-------|
| 1 | 웹소설 어시스턴트 프롬프트 체인 완성 | Novel_Assistant | 2026-03-31 | Ph2 | 2026-03-22 |
| 2 | 인스타툰 자동생성기 파이프라인 테스트 | InstatoonGen | 2026-03-31 | Ph2 | 2026-03-22 |
| 3 | 타이머 화면 UI 구현 | Pomory | 2026-04-15 | Ph3 | 2026-03-25 |

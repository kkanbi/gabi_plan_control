...
- **현재 페이즈**: Phase 3 — 🔥 본격 개발기 (2026.04 ~ 09)
- **4월 목표**: 열심히 진행 후 4월 말 계획 피드백 예정
- **가용 시간**: 하루 ~2시간 (육아 틈틈이)
...
### 3. 웹소설 집필 — 진행 중
- Repo: github.com/kkanbi/Novel_Assistant (어시스턴트 도구)
- 상태: 기능 완료 / 하루 5천자 집필 목표
- 목적: @creator_kkanbi 콘텐츠

### 완료된 프로젝트
- **gut-diary** — v1 완료 (2026-04-05), 장 트러블 식단 추적
- **웹소설 어시스턴트 개발** — 기능 완료 (2026-04-05)
- **인스타툰 자동생성기** — API 비용으로 보류, Gemini 직접 사용으로 대체

### 대기 중 프로젝트
- **버튜버 외주** → 시간 여유 생기면 (불확실)
- **타임블록 앱** → Phase 4 (2026.10~)
...
| Phase 2 | 2026.03 | 🌱 회복기 | 완료 |
| **Phase 3** | **2026.04 ~ 09** | **🔥 본격 개발기** | **← 현재** |
